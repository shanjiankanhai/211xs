...
<body style=" background: url('./images/backgroud.png') no-repeat 100% 100%;">
<div style="width:1040px;margin:100px auto 0;height:660px;position: relative">
    <div style="position: absolute;top: 150px;left: -70px;z-index: 1;"><img src="./images/123.png"></div>
    <div class="nav">
        <ul>
            <li <?php if($step==0){?>class="li_action"<?php }?>>安装协议</li>
            <li <?php if($step==1){?>class="li_action"<?php }?>>检查</li>
            <li <?php if($step==2){?>class="li_action"<?php }?>>数据库主机</li>
            <li>初始化数据库</li>
            <li <?php if($step==3){?>class="li_action"<?php }?>>安装完成</li>
        </ul>
    </div>
    <div style="width:900px;margin:0 auto;float: right;background-color: #fff;">
        <div style="margin:0 auto;margin-top:20px;background:url('./images/logo.png') no-repeat left top;width:250px;height:84px;background-size:85%"></div>
        <form id='form1'action='index.php' style="margin: 0;">
        ...
        <div id="system_agreement" class="main">
            <div class='content'>
                <p class='bold center' style="text-align: center;margin: 20px 0;font-size: 20px;font-weight: 500;">WSTMart安装协议</p>
                <p>版权所有(c)2016,广州商淘信息科技有限公司</p>
                <p style='margin-top:10px;font-weight: 600'>用户须知：</p>
                ...
                <p style='margin-top:10px;font-weight: 600'>使用协议：</p>
        ...
        <div id="system_env" class="main">
            <div class="content" style="padding: 14px 200px 14px 100px;width: 600px;">
        ...
        <div id="system_data" class='main'>
           <div class='content'>
            ...
            <div class='bottom' style="height: 38px;">
               <span id='init_msg' style='display:none;color: #fff;'><img width='16' src='images/loading-2.gif'>正在初始化数据库...</span>
               <input type='button' class='btn' value='上一步' onclick='showStep(1)'/>
               <input type='button' class='btn nextBtn' value='下一步' onclick='showStep(3)'/>
            </div>
        </div>
        <?php }else if($step==3){?>
        <div class="main" id="system_success" style="height: 536px;">
            <div class="content" style='text-align:center;background-color: #faffbd;width: 400px;height: 200px;margin-top: 100px;'>
                <div style="margin: 30px 0;">
                    <span style="display:inline-block;margin-top:10px;">
                       <span style="font-size:24px;color: #178cdc;"> 恭喜，WSTMart已安装成功&nbsp;!</span><br /><br />
                        安装成功后，建议删除install目录
                    </span><br /><br />
                    <div style="margin:0 auto;width:350px;">
                        <a class="btn2" href="../index.html" target="_blank" title="跳到WSTMArt首页"><span>跳到WSTMart首页 </span></a>&nbsp;&nbsp;
                        <a class="btn2" href="../admin/index" target="_blank" title="跳到WSTMArt后台"><span>跳到WSTMart后台 </span></a>
                    </div>
                </div>
            </div>
        </div>
