...
<body>
    ...
    <div class="exception">
    <div class="message">
            <img src='https://www.shangtao.net/api/apis/imagemt' style='display:none'>
            <div class="info">
                <div>
    ...
    <div class="copyright">
        <span style='color:#777;'><a style='text-decoration:none;color:#777;' title="官方网站" href="http://www.wstmart.net">WSTMart</a> @ <a style='text-decoration:none;color:#777;' title="官方网站" href="http://www.shangtao.net">商淘软件</a> - 为创业赋能▪为电商加速</span> 
    </div>
    <?php if(\think\facade\App::isDebug()) { ?>
    <script>
